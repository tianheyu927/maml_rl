...
from maml_examples.r7dof_vars import GOALS_LOCATION, default_sdof_env_option
import tensorflow as tf
import time

baselines = ['linear']
env_option = default_sdof_env_option
            ...
            for pre_std_modifier in pre_std_modifier_list:
                for fast_learning_rate in fast_learning_rates:
                    for bas in baselines:
                        ...
                        env = TfEnv(normalize(Reacher7DofMultitaskEnv(option=env_option)))
