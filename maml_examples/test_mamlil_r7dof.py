...
file1 = 'data/local/R7-IL-SPARSE-0619/R7_IL_SPARSE_200_40_1_1_dem40_ei5_as10_basl_1906_11_55/itr_88.pkl'
...
if not make_video:
    ...
    test_num_goals = 1
    goals = env.wrapped_env.wrapped_env.sample_goals(test_num_goals)
else:
    np.random.seed(1)
    rd.seed(1)
    tf.set_random_seed(1)
...
for step_i, initial_params_file in zip(range(len(step_sizes)), initial_params_files):
    ...
    for goal in goals:
        ...
        algo = VPG(
            ...
            extra_input=True, # added by RK 6/19
